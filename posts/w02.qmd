...
In this lesson we get started by looking at Segregation and Peer Effects. We will look at Schelling's model, Granovettor's threshold model, and the standing ovation model. We will also look at how to measure segregation.

::: callout-warning
## TLDR: Schelling👍🏽, Granovettor,👍🏽 Standing Ovation 👍🏽

![Segregation in a nutshell](images/in_a_nutshell.jpg)
...
-   Emergent properties of local models and Schelling's book "Micro Motives and Macro Behavior"
...
::: {#fig-mainmap .column-screen-inset-shaded }
```{mermaid}
...
Mindmap for Segregation Peer Effects and Threshold Models
:::
