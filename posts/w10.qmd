...
categories: ["model thinking", "Markov Processes", "Markov Chain", "Contagion models","diffusion","SIS model","R0", "SIR model","Herd Immunity","entropy","diversity index"]
from: markdown+emoji
draft: false
---
...
![Markov transition matrix](images/mt_matrix_02.jpg){.column-margin}
...
![Markov equilibrium matrix](images/mt_matrix_04.jpg){.column-margin}
...
## Markov model of democratisation {#sec-markov-model-of-democratisation}
